...
openssl pkey -in rsa_2048_private.pem -outform DER -out rsa_2048_private.der
...
openssl pkey -in ecdsa_p256_private.pem -outform DER -out ecdsa_p256_private.der
