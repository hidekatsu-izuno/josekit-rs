...
impl DerefMut for RsaJwsAlgorithm {
...
impl DerefMut for RsaJwsSigner {
    fn deref_mut(&mut self) -> &mut Self::Target {
        self
    }
}
...
impl DerefMut for RsaJwsVerifier {
    fn deref_mut(&mut self) -> &mut Self::Target {
        self
    }
}
