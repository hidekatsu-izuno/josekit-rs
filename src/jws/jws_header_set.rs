...
impl JwsHeaderSet {
    ...
    pub fn set_algorithm(&mut self, value: impl Into<String>, protection: bool) {
        ...
        if protection {
            ...
            self.unprotected.insert(key.to_string(), Value::String(value));
        }
    }
    ...
    pub fn set_jwk(&mut self, value: Jwk, protection: bool) {
        ...
        if protection {
            ...
            self.protected.remove(key);
            self.unprotected.insert(key.to_string(), Value::Object(value));
        }
    }
    ...
    pub fn set_x509_certificate_chain(&mut self, values: &Vec<impl AsRef<[u8]>>, protection: bool) {
        let key = "x5c";
        let vec = values.iter()
            .map(|v| Value::String(base64::encode_config(
                v.as_ref(),
