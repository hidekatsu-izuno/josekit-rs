...
pub fn serialize_compact(
    ...
    serialize_compact_with_selector(payload, header, |_header| Some(signer))
}
...
pub fn serialize_flattened_json(
    ...
    serialize_flattened_json_with_selector(payload, protected, header, |_header| Some(signer))
}
...
pub fn deserialize_compact(
    ...
    deserialize_compact_with_selector(input, |_header| Ok(Some(verifier)))
}
